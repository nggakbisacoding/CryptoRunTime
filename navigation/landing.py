...
def pageI():
    ...
    ### [GitHub Link](#)
    ### Feel free to use this tool for your cryptocurrency analysis! You can get real-time information about prices, price history, and cryptocurrency transaction volume. This is possible thanks to Yahoo Finance Library.
    ...
    ### To get started go to navigation in the sidebar. Then, select the desire crypto in the dropdown. By default, the start date is set for 2022/09/01 you can change this value at your own discretion. 
    ----
